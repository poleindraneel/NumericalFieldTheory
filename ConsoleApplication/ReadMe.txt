========================================================================
    KONSOLENANWENDUNG: ConsoleApplication-Projektübersicht
========================================================================

Diese ConsoleApplication-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ConsoleApplication-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ConsoleApplication.pch und eine 
